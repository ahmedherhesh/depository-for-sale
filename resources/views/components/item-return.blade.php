<div class="card book mb-2 me-2">
    <div class="book-img bg-light p-2 d-flex justify-content-between">
        ...
        @if ($user->id == $itemReturn->user_id || in_array($user->role, ['super-admin', 'admin']))
            <div class="d-flex gap-1">
                <a class="text-secondary" href="{{ route('returned.item.edit', $itemReturn->id) }}"
                    class="edit-btn btn p-0 "><i class="fa-solid fa-pen-to-square"></i></a>
    ...
    <div class="card-body">
        ...
        <p class="card-text m-0 pb-1 pe-1"><i class="fa-regular fa-user ps-2"></i>{{ $itemReturn->customer_name }}</p>
